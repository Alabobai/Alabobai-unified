    ...
    <div className="h-full flex flex-col bg-dark-400 overflow-hidden">
      ...
      <div className="p-6 border-b border-white/10 bg-gradient-to-r from-dark-300 to-dark-400">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-rose-gold-400/20 text-rose-gold-400 text-sm font-medium hover:bg-rose-gold-400/30 transition-colors"
            >
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="p-4 rounded-xl bg-white/5 border border-white/10 hover:border-rose-gold-400/30 transition-colors">
      ...
      <div className="flex-1 overflow-auto p-6 morphic-scrollbar">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-rose-gold-400/20 text-rose-gold-400 text-sm hover:bg-rose-gold-400/30 transition-colors">
        ...
        <div className="grid grid-cols-3 gap-4">
          {COMPANY_DEPARTMENTS.map(dept => (
            <button
              ...
              className={`department-card p-4 rounded-xl border text-left transition-all ${
                ...
                {dept.metrics.slice(0, 2).map((metric, i) => (
                  <div key={i}>
                    ...
                    <p className="text-sm font-medium text-white">
                      {metric.value}
                      {metric.change && (
                        <span className="text-green-400 text-xs ml-1">{metric.change}</span>
                      )}
                    </p>
                  </div>
                ))}
      ...
      <div className="p-4 border-t border-white/10 bg-dark-300">
        <div className="flex items-center gap-3">
          ...
          {[
            ...
            <button
              key={i}
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 text-white/70 text-xs hover:bg-white/10 hover:text-white transition-colors"
            >
